...
const contentListNoTitle = {
  HandlingResponsible: <p>The responsible in charge of handling the provided information is João Torres from the Informatics Engineering
    ...
    the support team regarding any concerns you might have by reaching out to me at <b>1201424@isep.ipp.pt</b>.
  </p>,
  CollectedData: <p>The only information collected on the moment of registration is your name and e-mail. You'll choose a password that
    is encrypted and I don't have access to, guaranteeing the desired security, and is only meant to allow you to
    login at any given time.
  </p>,
  Purposes: <p>The e-mail and password are required to allow the user to register and login in the application, and also for me
    to be able to verify an individual's identity. Your name, allied to your e-mail, allows me to contact the users, addressing them
